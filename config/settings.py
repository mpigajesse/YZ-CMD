...
NPM_BIN_PATH = "/usr/local/share/nvm/versions/node/v22.16.0/bin/npm"  # windows : C:/Program Files/nodejs/npm.cmd; github codespace /usr/local/share/nvm/versions/node/v22.16.0/bin/npm